export default (email: string) => {
  ...
  <head>
      ...
      <title>Request Pendirian Perusahaan</title>
                                                                                      ...
                                                                                      <td class="r2-c" align="center">
                                                                                          <table cellspacing="0"
                                                                                              ...
                                                                                              <tr>
                                                                                                  <td class="r15-i"
                                                                                                      style="font-size: 0px; line-height: 0px;">
                                                                                                      <img src="https://img.mailinblue.com/4654435/images/content_library/original/62836e60fb9029385c4216f8.png"
                                                                                                          width="270"
                                                                                                          border="0"
                                                                                                          class=""
                                                                                                          style="display: block; width: 100%;">
                                                                      ...
                                                                      <tr>
                                                                          ...
                                                                          <td valign="top" class="r17-i"
                                                                              ...
                                                                              <table width="100%" cellspacing="0"
                                                                                  ...
                                                                                  <tr>
                                                                                      <td class="r21-c" align="right">
                                                                                          <table cellspacing="0"
                                                                                              cellpadding="0" border="0"
                                                                                              role="presentation"
                                                                                              width="25" class="r22-o"
                                                                                              style="table-layout: fixed; width: 25px;">
                                                                                              <tr
                                                                                                  class="nl2go-responsive-hide">
                                                                                                  <td height="15"
                                                                                                      style="font-size: 15px; line-height: 15px;">
                                  ...
                                  <tr>
                                      <td class="r2-c" align="center">
                                          <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                              ...
                                              <!-- -->
                                              <tr>
                                                  <td class="r27-i" style="background-color: #00a0e4;">
                                                      <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                                          role="presentation">
                                                          <tr>
                                                              <th width="100%" valign="top" class="r5-c">
